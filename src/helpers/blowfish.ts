...
//   for (var i = 0; i < 18; ++i) {
//     const d =
//       ((this.key.charCodeAt(j % this.key.length) * 256 +
//         this.key.charCodeAt((j + 1) % this.key.length)) *
//         256 +
//         this.key.charCodeAt((j + 2) % this.key.length)) *
//         256 +
...
//     const l = t.substr(f, 4);
//     const r = t.substr(f + 4, 4);
...
//     const l = this.unescape(t.substr(f, 8));
//     const r = this.unescape(t.substr(f + 8, 8));
...
//     t.xor(
//       t.xor(
//         t.bf_S0[t.wordbyte0(b)] + t.bf_S1[t.wordbyte1(b)],
//         t.bf_S2[t.wordbyte2(b)]
//       ) + t.bf_S3[t.wordbyte3(b)],
//       t.bf_P[n]
//     )
//   );
// };
